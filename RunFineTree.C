...
void RunFineTree(TString InputFile="/eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/DPSproductionPatch1/Spring15.GJets_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_*_RA2AnalysisTree.root",TString OutputFile="GJets600HTInf.root", std::string Weight="0.0379"){//main programme
